    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('guardian', '监护人'), ('community_admin', '社区管理员'), ('system_admin', '系统管理员')], default='guardian', max_length=20, verbose_name='角色')),
                ('phone', models.CharField(blank=True, max_length=11, null=True, unique=True, verbose_name='手机号')),
                ('openid', models.CharField(blank=True, max_length=128, null=True, unique=True, verbose_name='微信OpenID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to='elderly_photos/', verbose_name='近照')),
                ('id_card', models.CharField(blank=True, max_length=18, null=True, verbose_name='身份证号')),
                ('notes', models.TextField(blank=True, verbose_name='备注')),
                ('is_active', models.BooleanField(default=True, verbose_name='是否启用')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('guardian', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='elderly_profiles', to=settings.AUTH_USER_MODEL, verbose_name='监护人')),
            ],
            options={
                'verbose_name': '老人档案',
